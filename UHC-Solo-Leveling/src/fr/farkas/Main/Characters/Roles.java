...
public class Roles {
	...
	public static final String GOTORYUJI = "GotoRyuji";
	...
	public static final String MINBYUNG = "MinByung";
	public static final String BAEKYOONHO = "BaekYoonho";
	public static final String YOOJINHO = "YooJinHo";
